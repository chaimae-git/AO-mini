<section class="section_2 form-step" id="section_2">
    ...
    <div class="partie_finance mb-4">
        <fieldset class="p-3 border scheduler-border">
            <legend class="scheduler-border text-capitalize" style="font-size:18px">Partie Financière </legend>
            <div class="row">
                <div class="col-4">
                    <div class="header  bg-blue-light p-2">
    ...
    <div class="patie_tech mb-4">
        <fieldset class="p-3 border scheduler-border">
            ...
            <div class="row">
                <div class="col-4">
                    <div class="header bg-blue-light p-2">
                        <h6 class="text-gray-dark text-capitalize m-0 text-bold">Départements</h6>
                    </div>
                    <div class="form-group">
                ...
                <div class="col-4">
                    <div class="header bg-blue-light p-2">
                        <h6 class="text-white text-capitalize m-0 text-gray-dark text-bold">Départements Affectés</h6>
                    </div>
    ...
    <div class="form-group clearfix">
        <div class="flex justify-content-between">
            <div class="button">
                <button class="pull-left btn bg-blue-button btn-prev text-white" type="button" value='suivant'>Précédant</button>
            </div>
            <div class="button">
