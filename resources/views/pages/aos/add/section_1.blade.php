<section class="section_1 form-step form-step-active" id="section_1">
    ...
    <div class="row mb-3">
        ...
        <div class="form-group col">
            <label for="ministere_id" class="mb-2">Ministère de Tuelle</label>
            <select name="ministere_id" class="form-control">
                <option value="">sélectionner le Ministère de Tuelle</option>
    ...
    <div class="row mb-3">
        ...
        <div class="form-group col">
            ...
            <select name="critere_selection_id" class="form-control">
                <option value="">Sélectionner un Critère de Sélection</option>
